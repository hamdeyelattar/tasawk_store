...
class __$$LoadinStateImplCopyWithImpl<$Res>
    extends _$DeleteProductStateCopyWithImpl<$Res, _$LoadinStateImpl>
...
class _$LoadinStateImpl implements LoadinState {
  const _$LoadinStateImpl({required this.productId});
...
abstract class LoadinState implements DeleteProductState {
  const factory LoadinState({required final String productId}) =
      _$LoadinStateImpl;
