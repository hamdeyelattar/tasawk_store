...
import 'package:tasawk/src/features/admin/add_products/presentation/widgets/create/create_product_image.dart';
                      ...
                      return CustomCreateDropDown(
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            final catgeoryIdString = catgeory.categoriesList
    ...
    if (fromKey.currentState!.validate() ||
      ...
      if (indexEmptyImage == -1) {
        ...
        context.read<CreateProductBloc>().add(
              CreateProductEvent.creatProduct(
